...
export function SustainabilityScorePage({
  ...
  const [formData, setFormData] = useState<SustainabilityFormData>(() => ({
    ...INITIAL_FORM_DATA,
    crop: initialCrop || INITIAL_FORM_DATA.crop,
    previous_crop: initialPreviousCrop || INITIAL_FORM_DATA.previous_crop,
    soil_type: initialSoilType || INITIAL_FORM_DATA.soil_type,
  }));

...
import { CheckCircle2, ShieldAlert, BarChart3, RefreshCw, Leaf, Tag, Sprout, AlertTriangle, Sparkles, Bot, Stethoscope } from 'lucide-react';
...
export function DiagnosisResult({
  ...
  const rawConfidence =
    typeof result.confidence === 'number' && Number.isFinite(result.confidence) ? result.confidence : 0;
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-3 pt-2">
        ...
        <Button
          ...
          variant="secondary"
          onClick={() => setIsChatOpen(true)}
          className="w-full sm:w-auto py-3 px-6 text-sm font-semibold rounded-xl border border-emerald-200 bg-emerald-50 hover:bg-emerald-100 text-emerald-800 flex items-center gap-2 cursor-pointer"

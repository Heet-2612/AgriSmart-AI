...
async def fetch_weather_by_location(location: str) -> WeatherResponse:
    """
    Fetch geocoding coordinates and forecast data from Open-Meteo API.
    Transforms data and returns a structured WeatherResponse with advisories.
    """
    ...
    async with httpx.AsyncClient(timeout=timeout) as client:
        # Step 1: Geocode location name to latitude and longitude
        try:
